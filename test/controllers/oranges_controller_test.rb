...
class OrangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orange" do
    assert_difference('Orange.count') do
      post oranges_url, params: { orange: { danceability: @orange.danceability, energy: @orange.energy, loudness: @orange.loudness, mode: @orange.mode, tempo: @orange.tempo, valence: @orange.valence } }
    end
  ...
  test "should update orange" do
    patch orange_url(@orange), params: { orange: { danceability: @orange.danceability, energy: @orange.energy, loudness: @orange.loudness, mode: @orange.mode, tempo: @orange.tempo, valence: @orange.valence } }
